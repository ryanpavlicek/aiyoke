...
- [ ] I added or updated focused tests and fixtures.
- [ ] I considered ownership, safe paths, cycles/conflicts, and secret redaction.
- [ ] `pnpm check` passes locally.

## Testing

<!-- Commands run and any environment-specific notes. -->
