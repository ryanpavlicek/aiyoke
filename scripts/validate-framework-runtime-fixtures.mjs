...
try {
  ...
  runPnpm(["install", "--ignore-workspace", "--frozen-lockfile=false"], { cwd: nodeRoot });
...
`,
  ...
  process.stdout.write("All generated framework runtime adapters passed real dependency checks.\n");
} catch (error) {
